...
export const defaultProducts = [
  {
    imageUrl:
      'https://objedname.eu/user-data/factories/80/imgs/items/13347.png',
    name: 'Banán Pomerančový džus',
    price: '80 Kč',
  },
  {
    imageUrl:
      'https://objedname.eu/user-data/factories/80/imgs/items/default_detail.jpg',
    name: 'pozdní sběr Červené víno',
    price: '199 Kč',
  },
  {
    imageUrl:
      'https://objedname.eu/user-data/factories/80/imgs/items/13338.png',
    name: 'Pivo Corona Extra',
    price: '80 Kč',
  },
  {
    imageUrl:
      'https://objedname.eu/user-data/factories/80/imgs/items/13345.png',
...
export const RecommendProductsBox: Component<Props> = (props) => {
  return (
    <div class="cart-recomend-box">
      ...
      <div
        style={{ display: props.products ? '' : 'none' }}
        class="recomend-products-box"
      >
